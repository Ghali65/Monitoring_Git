...
function IssueCard({ item, index, onCopy, copied }: {
  ...
  const preInfo   = hasPatch ? isPreRelease(item.recommended_fix!) : { isPreRelease: false, type: null };
    ...
    <div className="page">
      ...
      <header className="header">
        <div className="header-brand">
          <div className="header-brand-icon"><Shield size={17} /></div>
          <div>
            <div className="header-title">VulnTracker</div>
            <div className="header-subtitle">Dependency Security Monitor</div>
          </div>
        </div>
